...
public class LoginPageObjects extends Base{
	...
	public void enterUserName() {
		userNameFiled.sendKeys("homeira@gmail.com");
	}
	public void enterPassword() {
		passwordField.sendKeys("homeira9996");
	}
	...
	public void enterenterEmailAddress(String emailAddress) {
		enterenterEmailAddress(emailAddress);
	}
